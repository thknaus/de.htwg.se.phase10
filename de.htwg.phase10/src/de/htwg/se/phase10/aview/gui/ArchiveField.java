...
public class ArchiveField extends JPanel implements ActionListener{
	...
	public ArchiveField(Phase10gui g, IPhase10Controller con) {
        ...
        archive1.setPreferredSize(new Dimension(935,120));
        ...
        archive2.setPreferredSize(new Dimension(935,120));
        ...
        archive3.setPreferredSize(new Dimension(935,120));
        ...
        archive4.setPreferredSize(new Dimension(935,120));
        ...
        archive5.setPreferredSize(new Dimension(935,120));
        ...
        archive6.setPreferredSize(new Dimension(935,120));
        ...
        archive7.setPreferredSize(new Dimension(935,120));
        ...
        archive8.setPreferredSize(new Dimension(935,120));
        ...
        archive9.setPreferredSize(new Dimension(935,120));
        ...
        archive10.setPreferredSize(new Dimension(935,120));
